...
/**
 * Catatan penting:
 * Pastikan di proses login ORTU kamu set:
 *   $_SESSION['user_id'] = <id user>;
 *   $_SESSION['name']    = <nama ortu>;
 */
$ortu_id = $_SESSION['user_id'] ?? 0; // <- DIBENERIN: sebelumnya 'id'
...
if ($ortu_id > 0) {
    try {
        ...
        // optional: bisa kamu log errornya
...
/* Hitung umur bulan */
$umur_bulan = "-";
if ($balita && !empty($balita['tanggal_lahir'])) {
    try {
        ...
        <div class="card card-soft">
          <div class="card-body d-md-flex align-items-center justify-content-between">
            <div>
              ...
              <p class="text-muted mb-2">Pantau status gizi dan perkembangan balita Anda langsung dari dashboard ini.</p>
              <span class="chip"><i class="bi bi-info-circle me-1"></i> Tips: lakukan pemeriksaan rutin minimal sebulan sekali.</span>
            </div>
        ...
        <div class="card card-soft h-100">
          <div class="card-body">
            ...
            <?php if ($balita): ?>
              ...
              <p class="text-muted mb-1">Umur: <?= $umur_bulan ?> bulan</p>
              <p class="text-muted small mb-3">
                Jenis Kelamin: <?= $balita['jenis_kelamin'] === 'L' ? 'Laki-laki' : 'Perempuan' ?>
              </p>
            <?php else: ?>
              <h4 class="mb-1">Belum Ada Data</h4>
              <p class="text-muted small">Data balita akan muncul setelah diinput oleh tenaga kesehatan.</p>
            <?php endif; ?>
          ...
          <div class="card-body">
            ...
            <?php if ($latest): ?>
              ...
              <p class="text-muted mb-1">
                Pemeriksaan terakhir: <strong><?= htmlspecialchars($latest['tanggal_pemeriksaan']) ?></strong>
              </p>
            ...
            <?php else: ?>
              ...
              <p class="text-muted small mb-2">Status gizi akan muncul setelah pemeriksaan pertama dilakukan.</p>
            <?php endif; ?>
