...
<head>
  <meta charset="UTF-8">
  <title>Dashboard Orang Tua - Gizi Balita</title>
    ...
    <div class="collapse navbar-collapse" id="navbarOrtu">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
        ...
        <li class="nav-item mx-lg-1">
          <a class="nav-link active" href="<?= BASE_URL ?>/ortu/dashboard.php">
            Beranda
          </a>
        </li>
      ...
      <div class="col-md-6 col-xl-5">
        <div class="card card-soft h-100">
          <div class="card-body">
            ...
            <h4 class="mb-1">Nama Balita</h4>
            <p class="text-muted mb-3">Umur: - bulan</p>
            <p class="small text-muted mb-4">
              Data balita akan tampil setelah tenaga kesehatan memasukkannya ke dalam sistem.
              Anda dapat melihat riwayat pemeriksaan dan grafik perkembangan secara lengkap.
            </p>
      ...
      <div class="col-md-6 col-xl-7">
        <div class="card card-soft h-100">
          <div class="card-body">
            ...
            <!-- Dummy status, nanti diisi dari DB -->
            <span class="badge bg-secondary badge-status mb-2">
              Belum Ada Data
            </span>

            <p class="mb-1 text-muted">
              Pemeriksaan terakhir: <span class="fw-semibold">-</span>
            </p>
            <p class="small text-muted mb-3">
              Status gizi akan muncul setelah pemeriksaan dilakukan oleh tenaga kesehatan.
              Bila terdapat status "Gizi Kurang" atau "Risiko Gizi Lebih", ikuti rekomendasi pada artikel dan konsultasikan ke petugas kesehatan.
            </p>
  ...
  <div class="container-fluid px-4 px-md-5 py-3">
    <div class="d-md-flex justify-content-between align-items-center">
      ...
      <div class="text-md-end">
        <span class="me-2">Dibuat untuk membantu orang tua memantau gizi balita.</span>
      </div>
    </div>
  </div>
</footer>
