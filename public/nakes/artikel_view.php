...
<head>
  ...
  <title>
    <?php if ($artikel): ?>
      <?= htmlspecialchars($artikel['judul']); ?> - Artikel Edukasi - Gizi Balita (Nakes)
    <?php else: ?>
      Artikel Edukasi - Gizi Balita (Nakes)
    <?php endif; ?>
  </title>
  ...
  <div class="container-fluid px-4 px-md-5">
    ...
    <div class="row mb-3">
      <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
          <a href="<?= BASE_URL ?>/nakes/artikel_manage.php" class="btn btn-link btn-sm text-muted text-decoration-none ps-0">
            <i class="bi bi-arrow-left"></i> Kembali ke kelola artikel
          </a>
        </div>
      </div>
    </div>
            ...
            <?php if ($artikel): ?>
              ...
              <div class="artikel-meta mb-3">
                ...
                <span class="me-3">
                  ...
                  Status: <strong><?= htmlspecialchars($artikel['status']); ?></strong>
                </span>
              </div>
              ...
              <div class="artikel-konten">
                <?php
                // konten diasumsikan HTML dari editor nakes
                echo $artikel['konten'];
                // kalau mau pakai plain text:
  ...
  <div class="container-fluid px-4 px-md-5 py-3">
    <div class="d-md-flex justify-content-between align-items-center">
      ...
      <div class="text-md-end">
        <span class="me-2">Gunakan artikel ini sebagai bahan edukasi saat konseling dengan orang tua.</span>
      </div>
    </div>
  </div>
</footer>
